...
<body>
    ...
    <section class="main">
        <div class="poster">
            <img src="https://m.media-amazon.com/images/M/MV5BN2JmMjViMjMtZTM5Mi00ZGZkLTk5YzctZDg5MjFjZDE4NjNkXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg" alt="poster" width="320" height="420" class="img1">
        </div>
        <div class="maind">
            <h1 class="movname">A Separation(2011)</h1><br>
            <h3>Genres- Drama, Thriller</h3><br>
            <h3>Running Time- 2h 3min</h3><br>
            <h3>Language- Persian</h3><br>
            <h3>Country- Iran</h3><br>
    ...
    <section class="trailer">
        ...
        <div class="trailers">
            <iframe width="400" height="250" src="https://www.youtube.com/embed/58Onuy5USTc"></iframe>
            <iframe width="400" height="250" src="https://www.youtube.com/embed/LlMaGZuSlDY"></iframe>
            <iframe width="400" height="250" src="https://www.youtube.com/embed/KOEUgGqTQWg"></iframe>
        </div>
    </section>
    ...
    <section class="candc">
        ...
        <div class="names">
            <h3 class="title">Directed By-</h3><h3><b class="crew-link" id="2" data-toggle="popover" >Asghar&nbsp;&nbsp;Farhadi</b>,&nbsp;&nbsp;</h3><br>
            
            <h3 class="title">Written By- </h3><h3><b class="crew-link" id="2" data-toggle="popover" >Asghar Farhadi</b>,&nbsp;&nbsp;</h3><br>
            
            <h3 class="title">Produced By- </h3><h3><b class="crew-link" id="2" data-toggle="popover" >Asghar Farhadi</b>&nbsp;&nbsp;</h3><br>
            

            <h3 class="title">Cast(Top Billing)-</h3><h3><br> <span class="actors">
            <b class="crew-link" id="3" data-toggle="popover">Payman Maadi</b>&nbsp;&nbsp;
            <b class="crew-link" id="4" data-toggle="popover">Leila Hatami</b>&nbsp;&nbsp;
            <b class="crew-link" id="5" data-toggle="popover">Sareh Bayat</b>&nbsp;&nbsp;
            <b class="crew-link" id="6" data-toggle="popover">Shahab Hosseini</b>&nbsp;&nbsp;
    ...
    <section class="aandn">
        ...
        <div class="awards">
            Academy Award for Best Foreign Language Film of the Year<br><br>Golden Globe Award for Best Foreign Language Film of the Year<br><br>BAFTA Award for Best Film Not in the english language<br><br>Amazonas Award for Best Film
        </div>
    </section>
    ...
    <section class="streaming">
        ...
        <div class="stext">
            <a href="https://www.primevideo.com/search/ref=atv_sr_sug_8?phrase=a%20separation&ie=UTF8"><img class="slogo" src="primevideologo.jpg"
